...
public class TestParsePost {
    ...
    private static class ParseTree {
        ...
        ParseTree add(char value) {
            if (root == null) root = new LetterTree.LetterNode().setValue(value);
            return this;
        }

        ParseTree addLeftNode(LetterTree.LetterNode node) {
            root.setLeft(node);
            return this;
        }

        ParseTree addRightNode(LetterTree.LetterNode node) {
            root.setRight(node);
            return this;
        }

        void display() {
            LetterTree.Printer.printNode(root);
        }
        ...
        private void walkPost(LetterTree.LetterNode node) {
            if (node == null) return;
        ...
        private void walkPre(LetterTree.LetterNode node) {
            if (node == null) return;
